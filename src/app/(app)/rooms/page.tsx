...
function RoomsPageContent() {
  ...
  // Tạo phòng cần đăng nhập (API yêu cầu token). Chưa đăng nhập thì nhắc và
  // chuyển tới trang đăng nhập thay vì mở modal.
  function openCreate() {
    if (!getAccessToken()) {
      toast.warning(
        "Bạn cần đăng nhập",
    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      {showCreate && (
        <CreateRoomModal
          ...
          onCreated={() => {
            setShowCreate(false);
            // Chỉ làm mới danh sách để phòng vừa tạo hiện ngay; không tự vào phòng.
