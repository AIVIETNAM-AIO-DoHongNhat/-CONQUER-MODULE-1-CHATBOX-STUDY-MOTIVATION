// Logo AIOtivation - "mark" hình ngọn lửa (giữ nhịp/động lực) trong ô bo tròn,
// gradient sage → terracotta theo đúng tông thương hiệu. Kế thừa từ motif "giữ lửa".
...
// Logo đầy đủ: mark + chữ. `tone` đổi màu chữ cho nền sáng/tối.
export function Logo({
  ...
  return (
    <span className={`flex items-center gap-2.5 ${className ?? ""}`}>
      ...
      >
        <span className="font-extrabold">AIO</span>
        <span className="font-medium">tivation</span>
      </span>
    </span>
  );
}
